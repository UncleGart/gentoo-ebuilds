...
RDEPEND="
	>=sci-libs/coinor-clp-1.16.11
	>=sci-libs/coinor-cgl-0.59.10
	>=sci-libs/coinor-dylp-1.10.3
	>=sci-libs/coinor-osi-0.107.9
	>=sci-libs/coinor-utils-2.10.14
	>=sci-libs/coinor-vol-1.5.3"
DEPEND="${RDEPEND}
	virtual/pkgconfig
